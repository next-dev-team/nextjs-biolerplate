export default function Header({ children }: { children?: ReactNode }) {
	return (
		<Box typeBox="header" className="#mainHeader">
			<Box
				className={_tw('w-full border-b bg-white border-b-gray-200', _cons.mainHeaderCls)}
			>
					...
					<div className="flex items-center justify-end flex-1 md:justify-between">
							...
							<ul className="flex items-center gap-6 text-sm">
								<li>
									<Link href={'/components'}>
										<a className="font-semibold text-gray-500 transition hover:text-gray-500/75">
											Components
										</a>
									</Link>
								</li>
						...
						<div className="flex items-center gap-4">
							<div className="sm:gap-4 sm:flex">
								...
								<a className="hidden sm:block px-5 py-2.5 text-sm font-medium text-teal-600 bg-gray-100 rounded-md hover:text-teal-600/75 transition">
									Register
								</a>
							</div>
			...
			{children && (
				<Box
					className={_tw(
						'w-full border-b bg-gray-50 border-b-gray-200 px-8',
						_cons.mainHeaderSubCls
					)}
				>
					{children}
				</Box>
