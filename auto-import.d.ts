...
declare global {
  ...
  const _useAppSelector: typeof import('./src/stores/useAppStore/index')['_useAppSelector']
  const _useAppStore: typeof import('./src/stores/useAppStore/index')['_useAppStore']
  ...
  const dolphins: typeof import('./src/stores/github/index')['dolphins']
